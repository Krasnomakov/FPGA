...
HD_PWD='C:/Users/artur/baremetal_Software_project/baremetal_Software_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log baremetal_sw_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source baremetal_sw_design_wrapper.tcl -notrace
