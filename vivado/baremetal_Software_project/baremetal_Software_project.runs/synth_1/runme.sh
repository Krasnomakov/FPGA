...
HD_PWD='C:/Users/artur/baremetal_Software_project/baremetal_Software_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log baremetal_sw_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source baremetal_sw_design_wrapper.tcl
