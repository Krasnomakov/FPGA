...
#define BLINK_PERIOD_US_BTN1 500000 // 0.5 seconds
#define BLINK_PERIOD_US_BTN2 250000 // 0.25 seconds
#define BLINK_PERIOD_US_BTN3 125000 // 0.125 seconds
#define BLINK_PERIOD_US_BTN0 62500  // 0.0625 seconds
...
int main() {
    ...
    while (1) {
        ...
        if (data != prev_data) {
            ...
            u32 blink_period_us;
            switch (data) {
                case 0: blink_period_us = BLINK_PERIOD_US_BTN0; break;
                case 1: blink_period_us = BLINK_PERIOD_US_BTN1; break;
                case 2: blink_period_us = BLINK_PERIOD_US_BTN2; break;
                case 3: blink_period_us = BLINK_PERIOD_US_BTN3; break;
